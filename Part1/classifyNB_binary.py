# Calculated probability of each word in test dataset spam and non spam by checking if
# the word occurs in dictionary generated by train mode. If word occurs, calculating
# probabilty as number of times the word occured in spam/nonspam documents divided by
# the total number of spam/nonspam documents and also multipled by the prior probability
# of spam of not spam documents. Assigning the tag of spam or ham to max
# of the probabilites calculated.
